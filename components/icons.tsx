...
export const PresentationIcon = () => (
  <svg {...iconProps} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125v-11.25c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125m-17.25 0h17.25m-14.25-9l2.25 2.25 2.25-2.25m-4.5 0L9 12.75l3-3m-3 3l3 3m-3-3l-2.25 2.25m9-7.5h.008v.008h-.008v-.008z" />
  </svg>
);

export const WandIcon = () => (
  <svg {...iconProps} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a15.998 15.998 0 001.622-3.385m3.388 1.62a15.998 15.998 0 00-1.62-3.385m0 0a4.5 4.5 0 00-6.364-6.364l-1.127 1.127a4.5 4.5 0 00-6.364 6.364l1.127-1.127a4.5 4.5 0 006.364 6.364l-1.127 1.127z" />
  </svg>
);
